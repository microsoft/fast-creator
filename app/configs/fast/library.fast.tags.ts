 ...
 * FAST component tags
 */
export const fastAccordionItemTag = "fast-accordion-item";
export const fastAnchorTag = "fast-anchor";
export const fastAnchoredRegionTag = "fast-anchored-region";
...
export const fastListboxTag = "fast-listbox";
export const fastMenuTag = "fast-menu";
export const fastNumberFieldTag = "fast-number-field";
...
export const fastSelectTag = "fast-select";
